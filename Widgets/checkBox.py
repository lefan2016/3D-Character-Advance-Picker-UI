...
#-----------------------------------------------------------------------------------------------------#
    ...
    def paintEvent(self, event):
        ...
        if self.checkState():
            for index, pos, size, corner in zip(range(4), (6,7,8,9), (12,10,10,8), (10,10,10,10)):
...
#-----------------------------------------------------------------------------------------------------#
class CustomRedCheck(CustomCheck):
    _glowBrushes = {}
    for index in range(1, 11):
        _glowBrushes[index] = [QBrush(QColor(255, 0, 0,  1 * index)),
                               QBrush(QColor(255, 0, 0,  3 * index)),
                               QBrush(QColor(255, 0, 0, 15 * index)),
                               QBrush(QColor(200, 50, 50 , 25.5 * index))]
    _glowOffBrushes = {}
    for index in range(1, 11):
        _glowOffBrushes[index] = [QBrush(QColor(150, 0, 0,     1 * index)),
                                  QBrush(QColor(150, 0, 0,     6 * index)),
                                  QBrush(QColor(150, 0, 0,     9 * index)),
                                  QBrush(QColor(200, 50, 50 , 12 * index))]
